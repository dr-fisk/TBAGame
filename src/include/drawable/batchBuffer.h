...
class BatchBuffer {
  public:
    ...
    void genIboBuffer(const uint32_t cId, const uint32_t cSizeInBytes, const GLenum cDrawType);
    void genVboBuffer(const uint32_t cId, const uint32_t cSizeInBytes, const GLenum cDrawType);
